"""Signal model — Phase 6.

Identical contract to Phase 5.
SignalResult carries: market_id, question, outcome, p_model, p_market,
ev, edge_score, zscore, strategy.

CorrelationEngine uses dataclasses.replace() to produce adjusted copies

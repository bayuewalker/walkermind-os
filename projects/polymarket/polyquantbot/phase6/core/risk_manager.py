"""Fractional Kelly risk manager — Phase 6.

Unchanged from Phase 5. Used as a fallback utility; primary sizing
is handled by CapitalAllocator (engine/capital_allocator.py).
"""

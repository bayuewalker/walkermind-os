...
server/
  ...
  schemas/multi_user.py       -- Pydhantic schemas (User, Account, Wallet, ScopeContext)
...
- `asyncio_mode` pytest config warning is pre-existing higiene backlog — not a test failure. Carried as `[DEFERRED]`  in PROJECT_STATE.md.

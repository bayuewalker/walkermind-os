...
2026-05-06 05:03 | WARP/CRUSADERBOT-R12-LIVE-READINESS | R12 Live Readiness batch merged (PR #883) — live opt-in checklist (8 gates + audit + /live_checklist + CONFIRM dialog) + live-to-paper auto-fallback (router/risk gate/kill switch cascade) + daily P&L summary (cron 23:00 Jakarta + /summary_on /summary_off). STANDARD, NARROW INTEGRATION. 331/331 tests pass.

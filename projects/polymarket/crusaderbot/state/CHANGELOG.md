...
2026-05-28 21:30 | WARP/ROOT-preset-guard-label | NULL preset safety guard (scan skip + /autotrade/toggle 400) + active_preset label fix for late_entry_v3 portfolio display (migration 062, execution chain, API, frontend PRESET_LABEL map). STANDARD, NARROW INTEGRATION. Report: reports/forge/preset-guard-label.md.

2026-05-05 18:45 Asia/Jakarta | WARP/CRUSADERBOT-FIX-MIGRATION-PATH | Migration runner path fix: git mv 008_strategy_tables.sql from infra/migrations/ to migrations/ so database.run_migrations() actually applies it at startup. Pure rename (similarity 100%, byte-identical content). 009_copy_trade.sql out of scope — lives on PR #877 branch, follow-up move required there. Tier: MINOR. Claim: FILE MOVE ONLY — zero logic change.

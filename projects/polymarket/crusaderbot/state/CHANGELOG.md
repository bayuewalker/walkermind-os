...
2026-05-25 11:00 | WARP/close-sweep-pipeline-fix | WARP-47 Close Sweep pipeline fix MERGED PR #1336 — 4 bugs (BUG1 market_id=conditionId, BUG2 condition_ids plural+validation, BUG3 active gate skip for candle slugs, BUG4 scan telemetry) + CI fix (get_settings() try/except fallback)

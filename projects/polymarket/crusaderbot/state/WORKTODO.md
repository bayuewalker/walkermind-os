...
- [ ] WARP•R00T full-system pre-public audit fix campaign — verdict CONDITIONAL (safety/money core APPROVED + fail-closed; user-facing correctness + API hardening + pre-LIVE money-path lanes opened). Lanes:
  ...
  - [ ] Lane 5/5 WARP/ROOT/live-path-hardening [MAJOR, pre-LIVE] — master-EOA nonce lock + pending tag, submit_live_redemption gas ceiling, signal_scan live_capital_cap_usdc SELECT, _passes_live_guards USE_REAL_CLOB + Kelly bound alignment, MAX_CONCURRENT_TRADES enforcement.

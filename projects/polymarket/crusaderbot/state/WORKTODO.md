...
## Right Now
- [ ] crusaderbot-finalize — PR open (WARP/crusaderbot-finalize, 2026-05-17). Public-ready paper beta: ENABLE_LIVE_TRADING default→False, copy-task P&L, notifications_on enforced fail-open, sweep count fix + audit, ops client_host breadcrumb, pytest.ini fix, .env.example + DEPLOY runbook + PRODUCTION_CHECKLIST.md. 1432 pytest pass, ruff clean. MAJOR, NARROW INTEGRATION. Awaiting WARP•SENTINEL validation then WARP🔹CMD merge.
